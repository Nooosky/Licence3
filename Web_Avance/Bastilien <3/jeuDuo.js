...
function chooseInstruction(index){
...
function getClickPosition(e) {
  ...
  if((xPosition >= 30 && xPosition <= 110) || (xPosition >= shift + 30 && xPosition <= shift + 110)){
    console.log("right column");
    if(yPosition >= 16 && yPosition <= 96){
      console.log("INST1");
    }else if(yPosition >= 128 && yPosition <= 208){
      console.log("INST2");
      PopupCenter(800, 200);
    }else if(yPosition >= 240 && yPosition <= 320){
      console.log("INST3");
    }else if(yPosition >= 352 && yPosition <= 432){
      console.log("INST4");
    }else if(yPosition >= 464 && yPosition <= 544){
      console.log("INST5");
    }else if(yPosition >= 576 && yPosition <= 656){
      console.log("INST6");
    }
  }
}
...
function PopupCenter(w, h) {
  ...
  annuler.setAttribute("src", "http://localhost/WebA/TP2/images/annuler-"+colour+".png");
  ...
  deposer.setAttribute("src", "http://localhost/WebA/TP2/images/deposer-"+colour+".png");
  ...
  est.setAttribute("src", "http://localhost/WebA/TP2/images/est-"+colour+".png");
  ...
  nord.setAttribute("src", "http://localhost/WebA/TP2/images/nord-"+colour+".png");
  ...
  ouest.setAttribute("src", "http://localhost/WebA/TP2/images/ouest-"+colour+".png");
  ...
  pause.setAttribute("src", "http://localhost/WebA/TP2/images/pause-"+colour+".png");
  ...
  prendre.setAttribute("src", "http://localhost/WebA/TP2/images/prendre-"+colour+".png");
  ...
  repousser.setAttribute("src", "http://localhost/WebA/TP2/images/repousser-"+colour+".png");
  ...
  sud.setAttribute("src", "http://localhost/WebA/TP2/images/sud-"+colour+".png");
  ...
  x2.setAttribute("src", "http://localhost/WebA/TP2/images/x2-"+colour+".png");
...
left_canvas.addEventListener("click", getClickPosition, false);
right_canvas.addEventListener("click", getClickPosition, false);
