...
TEST(fa_remove_non_co_accessible_states, state_no_transition)
{
...
TEST(fa_remove_non_co_accessible_states, state_w_transition)
{
  struct fa *selfFa = (struct fa *) malloc(sizeof(struct fa));
  fa_create(selfFa, 2, 3);
...
TEST(fa_remove_non_co_accessible_states, state_accessible)
{
  struct fa *selfFa = (struct fa *) malloc(sizeof(struct fa));
  fa_create(selfFa, 2, 3);
